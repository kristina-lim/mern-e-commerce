...
(async function() {
  ...
  const costumes = await Costume.create([
    ...
    {name: 'Rudolph the Red Nosed Reindeer', emoji: '🦌', category: categories[1], price: 45.95},
    ...
    {name: 'Count Dracula w/ Mustache Costume', emoji: '🧛‍♀️', category: categories[3], price: 45.95},
